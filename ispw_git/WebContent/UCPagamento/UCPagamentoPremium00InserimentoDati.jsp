...
<div class="container">
    ...
    <form class="col s12" action="UCPagamentoPremium01RiepilogoDati.jsp" method="post">

        <label>Tipo di abbonamento</label>

        <br>

        <select class="browser-default" name="abbonamento">
        ...
        <button class="btn waves-effect waves-light" type="submit" name="action">Conferma dati e procedi all'acquisto
        </button>
