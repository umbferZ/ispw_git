...
<div class="container">
	...
	<form class="col s12" action="UCPagamentoPremium01RiepilogoDati.jsp"
		method="post">
		<label>Tipo di abbonamento</label> <br> <select
			class="browser-default" name="abbonamento">
			<option value="" disabled selected>Scegli il tipo di
				abbonamento</option>
			<option value="17,99 euro (Mensile)">Mensile (17,99 euro)</option>
			<option value="179,99 euro (Annuale)">Annuale (179,99 euro)</option>
		</select> <br> <label>Tipo di carta</label> <br> <select
		...
		<button class="btn waves-effect waves-light" type="submit"
			name="action">Conferma dati e procedi all'acquisto</button>
	</form>
	<br>
