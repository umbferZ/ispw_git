    ...
    <form class="col s12" action="UCEventi01RiepilogoDatiEvento.jsp" method="post">
        ...
        <div class="row">
            <div class="input-field col s6">
                <input placeholder="Nome dell'evento" name="name" id="name" type="text" class="validate">
            </div>
        </div>

        <div class="row">
            <div class="input-field col s6">
                <input placeholder="Descrizione" name="descrizione" id="descrizione" type="text" class="validate">
            </div>
        </div>

        <div class="row">
            <div class="input-field col s6">
                <input placeholder="Luogo" name="luogo" id="luogo" type="text" class="validate">
            </div>
        </div>

        <div class="row">
            <div class="input-field col s6">
                <input placeholder="Orario" name="orario" id="orario" type="text" class="validate">
            </div>
        </div>
        ...
        <button class="btn waves-effect waves-light" type="submit" name="action" value="conferma">Inserisci Evento
        </button>
