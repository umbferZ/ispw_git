    ...
    <div class="col s12 m7">
        <div class="card">
            ...
            <div class="card-content">
                <p>Uniche due date italiane per il tour dei record del "Boss". Il 3 e 16 Luglio rispettivamente a Milano e Roma.</p>
            </div>
...
<div class="container">
    <td>
        <form method="post" action="UCPromozioni02ListaPromozioni.jsp">
            <button class="btn waves-effect waves-light" type="submit" name="action">Crea promozione</button>
        </form>
    </td>
</div>
</body>
