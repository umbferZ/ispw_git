...
import entity.pagamenti.Transaction;
import entity.pagamenti.TransactionsList;
...
public class PaymentControl {
	...
	if (!x) {
	    ...
	    Transaction transaction = new Transaction(10d, 100, 1422);

	    // TODO: sostituire parametri Transaction con get e set del Bean
	    // TODO: utilizza Thread

	    // load TransactionsList

	    TransactionsList transactionsList;
	    LoadAndStoreObjectsOnFile transactionListStream = new LoadAndStoreObjectsOnFile("./transactionsList.txt");
	    transactionsList = (TransactionsList) transactionListStream.loadObject();

	    // addTransaction on TransactionsList

	    transactionsList.addTransaction(transaction);
	    LoadAndStoreObjectsOnFile outStream = new LoadAndStoreObjectsOnFile("./transactionsList.txt");
	    outStream.storeObject(transactionsList);

	    // TODO: crea fattura e invia mail
