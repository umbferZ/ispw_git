...
public abstract class Struttura {
	...
	String[] label = { "nome", "regione", "citta", "comune", "via", "num", "cap", "descrizione",
		"locatore_idlocatore" };
	Object[] value = { this.getNome(), this.getIndirizzo().getRegione(), this.getIndirizzo().getCitta(),
		this.getIndirizzo().getComune(), this.getIndirizzo().getVia(), this.getIndirizzo().getNumCivic(),
		this.getIndirizzo().getCAP(), this.getDescrizione(), this.getLocatore().getId_utenteRegistrato() };
